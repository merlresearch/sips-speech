...
# Specific files:
# - https://github.com/kaituoxu/Conv-TasNet/blob/0d9d9dcd8037b396fd029000af58cda6b7663b11/src/conv_tasnet.py
# - https://github.com/kaituoxu/Conv-TasNet/blob/0d9d9dcd8037b396fd029000af58cda6b7663b11/src/utils.py
# 
...
# --------------------------------------------------------------------------------------
# https://github.com/kaituoxu/Conv-TasNet/blob/0d9d9dcd8037b396fd029000af58cda6b7663b11/src/utils.py#L9-L66
...
def overlap_and_add(signal, frame_step):
    ...
    frame = torch.as_tensor(frame, device=signal.device, dtype=torch.long)
...
# --------------------------------------------------------------------------------------
# Adapted from https://github.com/kaituoxu/Conv-TasNet/blob/0d9d9dcd8037b396fd029000af58cda6b7663b11/src/conv_tasnet.py#L10-L355
...
class ConvTasNet(nn.Module):
    ...
    def enhance(self, mixture):
        length = torch.tensor([mixture.size(-1)])
        estimate_source = self(mixture)  # [B, C, T]
        flat_estimate = remove_pad(estimate_source, length)
        x_hat =  torch.from_numpy(flat_estimate[0]).to(mixture.device)
        return x_hat
